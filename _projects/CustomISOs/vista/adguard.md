...
- It's a simple updated ISO.
- Comes with Internet Explorer 9 that can be reverted to Internet Explorer 7.

**Cons:**

- Doesn't have any .NET Framework past 3.0 Service Pack 2.
- Windows Update doesn't work by default.
- The PE is the stock Vista one with no extra drivers installed.
- Doesn't come with any extra drivers so you might have to supply your own (e.g Ethernet, NVME drivers, etc.).
- Certain patches (e.g. CI patches) won't work due to ESU updates changing those files slightly and making patching fail.
...
- Comes in both x64 and x86 (**Note:** the x86 release is only on the adguard forum page).
- It's a simple updated ISO.
- Comes with Internet Explorer 9 that can be reverted to Internet Explorer 7.
